    ...
    <header className="fixed top-0 w-full bg-[#f6f5f5] shadow-md py-2 px-4 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link href="/applications" className="text-[#070d59] hover:text-[#ee6f57] font-medium">Applications</Link>
          <Link href="/applications" className="text-[#070d59] hover:text-[#ee6f57] font-medium">Dashboard</Link>
          {user ? (
